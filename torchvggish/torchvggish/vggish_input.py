...
class AudioFileLargerThanDefinedMax(Exception):
    pass
...
def waveform_to_examples(data, sample_rate, return_tensor=True):
  ...
  """
    ...
    log_mel_examples = mel_features.frame_with_padding(
        log_mel,
...
def wavfile_to_examples(wav_file, return_tensor=True):
  ...
  """
    ...
    if wav_data.shape[0] >= vggish_params.MAX_AUDIO_LENGTH_SEC*sr :
      raise AudioFileLargerThanDefinedMax
